...
private extension StationSearchViewController {
    func setNavigationItems() {
        ...
        searchController.obscuresBackgroundDuringPresentation = false   // SearchController 선택 히 배경 회색 여부
    ...
    func requestStationName(from stationName: String) {
        let urlString = "http://openapi.seoul.go.kr:8088/sample/xml/SearchInfoBySubwayNameService/1/5/\(stationName)"
        print(urlString)
