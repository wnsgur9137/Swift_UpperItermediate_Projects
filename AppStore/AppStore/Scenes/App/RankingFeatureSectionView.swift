...
final class RankingFeautreSectionView: UIView {
...
extension RankingFeautreSectionView: UICollectionViewDataSource {
...
private extension RankingFeautreSectionView {
    func setupViews() {
        ...
        collectionView.snp.makeConstraints {
            ...
            $0.height.equalTo(RankingFeatureCollectionViewCell.height * 3)   // 셀의 개수와 같은 의미이다.
